import { getAllTheaters } from "../data.js";
...
export async function showHome() {
    ...
    let allTheaters = await getAllTheaters();
    render(homeTemplate(allTheaters), mainElement);
}

let homeTemplate = (allTheaters) => {
...
<section class="welcomePage">
    ...
    : html`${allTheaters.map(theaterTemplate)}`}
    </div>
    </div>
</section>`;
